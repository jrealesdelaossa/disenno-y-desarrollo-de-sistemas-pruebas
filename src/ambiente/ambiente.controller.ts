...
export class AmbienteController {
    ...
    @Patch('editar/:id')
    async updateAmbiente(@Body() updateAmbiente: UpdateAmbienteDTO, @Param('id') idAmbiente: string) {
        const updAmbiente = await this.ambienteService.updateAmbiente(idAmbiente, updateAmbiente);
        return updAmbiente;
    }
